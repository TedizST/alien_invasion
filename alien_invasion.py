...
class AlienInvasion:
    ...
    def __init__(self):
        """Инициализирует игру и создает основные ресурсы."""
        pygame.init()
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if collisions:
            self.counting_of_score(collisions)

        if not self.aliens:
            self.start_new_level()

    def counting_of_score(self, collisions):
    ...
    def _update_screen(self):
        """Обновляет изображения на экране и добавляет новый экран."""
